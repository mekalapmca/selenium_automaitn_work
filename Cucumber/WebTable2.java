...
public class WebTable2 {
	...
	public static void main(String[] args) {
		...
		String expUsername = "amit_one";
		
		String actualxpath = "//*[@id='resultTable']//tr[1]//td[2]//a";
		
		String username1 = driver.findElement(By.xpath(actualxpath)).getText();
		System.out.println(username1);
		
          String actualxpath2 = "//*[@id='resultTable']//tr[2]//td[2]//a";
		
		String username2 = driver.findElement(By.xpath(actualxpath)).getText();
